...
$host="www.devworms.com";
    ...
    $consulta = mysqli_query($con, "SELECT Total,Concepto FROM inv_activos05a Where ID_proyecto='$proyecto'");

        if (mysqli_num_rows($consulta) > 0)
        {
          $query = "SELECT Total,Concepto FROM inv_activos05a Where ID_proyecto='$proyecto'";
          ...
          $query2 = "SELECT ID_proyecto,Periodo,Monto_admon FROM costos_gastos12 WHERE ID_proyecto = '$proyecto'";
          ...
          while($row2=mysqli_fetch_array($result2,MYSQLI_NUM)){
           ...
           $rows2[]=$row2;
                        ...
                        $pdf->SetXY(170,30);
                         ...
                         $pdf->SetXY(160,45);
                         $pdf->Cell(130,10, utf8_decode('Producción:_________________'),0,0,'L');

                         $pdf->SetXY(20,60);
                         $pdf->Cell(130,10,'Producto/Servicio:________________',0,0,'L');
